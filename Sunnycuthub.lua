...
notis.new("<Color=White>SunnyX Hub<Color=/>"):Display()
...
local Tabs = {
    Info = Window:AddTab({ Title = "Proflie", Icon = "" }),
    Main = Window:AddTab({ Title = "Farm 1", Icon = "" }),
    Main2 = Window:AddTab({ Title = "Farm 2", Icon = "" }),
    Main3 = Window:AddTab({ Title = "Farm 3", Icon = "" }),
...
Tabs.Info:AddButton({
    ...
    Description = "Discord",
    Callback = function()
        setclipboard("https://discord.gg/mMMZrH5kbb")
    end
})

Tabs.Info:AddButton({
    Title = "Developer Hub",
    Description = "Windy, Vỹ Gaming Admin",
    Callback = function()
        setclipboard("")
    end
})
...
ImageButton.Image = "https://www.roblox.com/asset/?id=18287921093"
