"https://discord.gg/CvkUHHGnvN"

-- getgenv().Crack = {
--     GetCrack = true,
--     BypassWL = true,
--     Keys = "Leak By Annonymous",
--     DiscordID = "892628451142557718"
-- }
...
-- getgenv().Configs = {
--     Blox_Fruits_Kaitun_Enabled = false,
--     Blox_Fruits_Bounty_Enabled = false
-- }

repeat wait(1) until game:IsLoaded()

do
	local ui = game.CoreGui:FindFirstChild("Luxury HUB V2")
	if ui then
		ui:Destroy()
	end
end
...
function library:Window(text,text2,text3,logo,keybind)
	...
	local Luxury HUB V2 = Instance.new("ScreenGui")
	Luxury HUB V2.Name = "Luxury HUB V2"
	Luxury HUB V2.Parent = game.CoreGui
	Luxury HUB V2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = Luxury HUB V2
	...
	Logo.Image = "rbxassetid://"..tostring(15469706221)
	...
	ToggleImgUi.Image = "rbxassetid://15469706221"
	...
	function uitab:Tab(text,logo1)
		...
		function main:Dropdown(text,option,callback)
			...
			DropImage.Image = "rbxassetid://15469706221"
...
_G.ColorButton = Color3.fromRGB(255, 0, 0)
--Script
...
local win = library:Window(" Luxurious ",[[Hub]],"15469706221",Enum.KeyCode.RightControl)
